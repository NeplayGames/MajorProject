...
class DecoderRNN(nn.Module):
    def __init__(self, vocab_size, num_layers=1):
        ...
        self.rnn_model = nn.GRU(self.embedding_size, self.hidden_feature_size, num_layers=self.number_layers,
                                batch_first=True)
    ...
    def sample(self, inputs, states=None, max_len=20):
        # accepts pre-processed image tensor (inputs) and returns predicted sentence (list of tensor ids of length
        # max_len)
